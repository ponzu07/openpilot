...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"DoorLockCmd", {CLEAR_ON_MANAGER_START, STRING}},
    ...
    {"MadsSteeringMode", {PERSISTENT, INT, "1"}},
    ...
    {"UseCommaBackend", {PERSISTENT, BOOL}},
